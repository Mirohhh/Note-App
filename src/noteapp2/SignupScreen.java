...
public class SignupScreen extends javax.swing.JFrame {
    ...
    //Method that takes the text entered in the username and password fileds
    //and creates a user with them then passes this data to the sign-in screen
    //and makes the sign-in screen visible after disposing the sign-up screen
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        fm.addUser(u);
        this.dispose();
        SigninScreen sc = new SigninScreen();
        sc.u = u;
        sc.fm = fm;
        sc.setVisible(true);
        }
